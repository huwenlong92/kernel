...
class LogManager implements LoggerInterface
{
    ...
    {
        return new Monolog('Larkit', $this->prepareHandlers([new StreamHandler(
            \sys_get_temp_dir().'/Larkit/Larkit.log',
    ...
    {
        return new Monolog('Larkit', [new NullHandler()]);
    }
